...
if (!isset($localize)){
        ...
        if( $localize!='en' && $localize!='el' && $localize!='es' ){ $localize='el'; }
}
...
if (isset($_GET['delete'])) {
        ...
        $title_en = htmlspecialchars($title_en, ENT_QUOTES);
        $newContent_en = htmlspecialchars($newContent_en, ENT_QUOTES);
        $comment_en = htmlspecialchars($comment_en, ENT_QUOTES);
	...
	// submit announcement command
        if (isset($_POST['id'])) {
                ...
                db_query_safe("UPDATE admin_announcements
                        SET gr_title = ?, gr_body = ?, gr_comment = ?,
                        en_title = ?, en_body = ?, en_comment = ?,
                        visible = ?, date = NOW()
                        WHERE id = ?", 
                        array($title, $newContent, $comment, $title_en, $newContent_en, $comment_en, $visible, $id),
                        $mysqlMainDb);
                ...
                /*db_query("INSERT INTO admin_announcements
                        ...
                        en_title = $title_en, en_body = $newContent_en, en_comment = $comment_en,
                        visible = '$visible', date = NOW()");*/
                db_query_safe("INSERT INTO admin_announcements
                        SET gr_title = ?, gr_body = ?, gr_comment = ?,
                        en_title = ?, en_body = ?, en_comment = ?,
                        visible = ?, date = NOW()",
                        array($title,$newContent,$comment,$title_en,$newContent_en,$comment_en,$visible),
                        $mysqlMainDb);
