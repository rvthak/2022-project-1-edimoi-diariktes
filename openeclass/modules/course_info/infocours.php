...
if (isset($_POST['submit'])) {
        if (empty($_POST['title'])) {
                ...
                if (isset($_POST['localize'])) {
                        ...
                        $tmp = $_POST['localize'];
                        if( $tmp!='en' && $tmp!='el' && $tmp!='es' ){ $tmp='el'; }
                        $newlang = $language = langcode_to_name($tmp);
			...
			"UPDATE `$mysqlMainDb`.cours
                        ...
                        faculteid = ?
                        WHERE cours_id = ?",
			array($_POST['title'], $facname, $_POST['description'], $_POST['course_addon'], $_POST['course_keywords'],
                        $_POST['formvisible'], $_POST['titulary'], $newlang, $_POST['type'], $_POST['password'], $facid, $cours_id)
		);

                db_query_safe(
                        "UPDATE `$mysqlMainDb`.cours_faculte
                        SET faculte = ?, facid = ?
                        WHERE code=?",
                        array($facname, $facid, $currentCourseID)
                );
                ...
                db_query_safe("UPDATE accueil SET rubrique= ? WHERE define_var='MODULE_ID_AGENDA'", array($langAgenda), $currentCourseID);
                //db_query("UPDATE `$currentCourseID`.accueil SET rubrique='$langLinks' WHERE define_var='MODULE_ID_LINKS'");
                db_query_safe("UPDATE accueil SET rubrique= ? WHERE define_var='MODULE_ID_LINKS'", array($langLinks), $currentCourseID);
                //db_query("UPDATE `$currentCourseID`.accueil SET rubrique='$langDoc' WHERE define_var='MODULE_ID_DOCS'");
                db_query_safe("UPDATE accueil SET rubrique= ? WHERE define_var='MODULE_ID_DOCS'", array($langDoc), $currentCourseID);
                //db_query("UPDATE `$currentCourseID`.accueil SET rubrique='$langVideo' WHERE define_var='MODULE_ID_VIDEO'");
                db_query_safe("UPDATE accueil SET rubrique= ? WHERE define_var='MODULE_ID_VIDEO'", array($langVideo), $currentCourseID);
                //db_query("UPDATE `$currentCourseID`.accueil SET rubrique='$langWorks' WHERE define_var='MODULE_ID_ASSIGN'");
                db_query_safe("UPDATE accueil SET rubrique= ? WHERE define_var='MODULE_ID_ASSIGN'", array($langWorks), $currentCourseID);
                //db_query("UPDATE `$currentCourseID`.accueil SET rubrique='$langAnnouncements' WHERE define_var='MODULE_ID_ANNOUNCE'");
                db_query_safe("UPDATE accueil SET rubrique= ? WHERE define_var='MODULE_ID_ANNOUNCE'", array($langAnnouncements), $currentCourseID);
                //db_query("UPDATE `$currentCourseID`.accueil SET rubrique='$langAdminUsers' WHERE define_var='MODULE_ID_USERS'");
                db_query_safe("UPDATE accueil SET rubrique= ? WHERE define_var='MODULE_ID_USERS'", array($langAdminUsers), $currentCourseID);
                //db_query("UPDATE `$currentCourseID`.accueil SET rubrique='$langForums' WHERE define_var='MODULE_ID_FORUM'");
                db_query_safe("UPDATE accueil SET rubrique= ? WHERE define_var='MODULE_ID_FORUM'", array($langForums), $currentCourseID);
                //db_query("UPDATE `$currentCourseID`.accueil SET rubrique='$langExercices' WHERE define_var='MODULE_ID_EXERCISE'");
                db_query_safe("UPDATE accueil SET rubrique= ? WHERE define_var='MODULE_ID_EXERCISE'", array($langExercices), $currentCourseID);
                //db_query("UPDATE `$currentCourseID`.accueil SET rubrique='$langModifyInfo' WHERE define_var='MODULE_ID_COURSEINFO'");
                db_query_safe("UPDATE accueil SET rubrique= ? WHERE define_var='MODULE_ID_COURSEINFO'", array($langModifyInfo), $currentCourseID);
                //db_query("UPDATE `$currentCourseID`.accueil SET rubrique='$langGroups' WHERE define_var='MODULE_ID_GROUPS'");
                db_query_safe("UPDATE accueil SET rubrique= ? WHERE define_var='MODULE_ID_GROUPS'", array($langGroups), $currentCourseID);
                //db_query("UPDATE `$currentCourseID`.accueil SET rubrique='$langDropBox' WHERE define_var='MODULE_ID_DROPBOX'");
                db_query_safe("UPDATE accueil SET rubrique= ? WHERE define_var='MODULE_ID_DROPBOX'", array($langDropBox), $currentCourseID);
                //db_query("UPDATE `$currentCourseID`.accueil SET rubrique='$langConference' WHERE define_var='MODULE_ID_CHAT'");
                db_query_safe("UPDATE accueil SET rubrique= ? WHERE define_var='MODULE_ID_CHAT'", array($langConference), $currentCourseID);
                //db_query("UPDATE `$currentCourseID`.accueil SET rubrique='$langCourseDescription' WHERE define_var='MODULE_ID_DESCRIPTION'");
                db_query_safe("UPDATE accueil SET rubrique= ? WHERE define_var='MODULE_ID_DESCRIPTION'", array($langCourseDescription), $currentCourseID);
                //db_query("UPDATE `$currentCourseID`.accueil SET rubrique='$langQuestionnaire' WHERE define_var='MODULE_ID_QUESTIONNAIRE'");
                db_query_safe("UPDATE accueil SET rubrique= ? WHERE define_var='MODULE_ID_QUESTIONNAIRE'", array($langQuestionnaire), $currentCourseID);
                //db_query("UPDATE `$currentCourseID`.accueil SET rubrique='$langLearnPath' WHERE define_var='MODULE_ID_LP'");
                db_query_safe("UPDATE accueil SET rubrique= ? WHERE define_var='MODULE_ID_LP'", array($langLearnPath), $currentCourseID);
                //db_query("UPDATE `$currentCourseID`.accueil SET rubrique='$langUsage' WHERE define_var='MODULE_ID_USAGE'");
                db_query_safe("UPDATE accueil SET rubrique= ? WHERE define_var='MODULE_ID_USAGE'", array($langUsage), $currentCourseID);
                //db_query("UPDATE `$currentCourseID`.accueil SET rubrique='$langToolManagement' WHERE define_var='MODULE_ID_TOOLADMIN'");
                db_query_safe("UPDATE accueil SET rubrique= ? WHERE define_var='MODULE_ID_TOOLADMIN'", array($langToolManagement), $currentCourseID);
                //db_query("UPDATE `$currentCourseID`.accueil SET rubrique='$langWiki' WHERE define_var='MODULE_ID_WIKI'");
                db_query_safe("UPDATE `$currentCourseID`.accueil SET rubrique= ? WHERE define_var='MODULE_ID_WIKI'", array($langWiki), $currentCourseID);
                //db_query("UPDATE `$currentCourseID`.accueil SET rubrique='$langCourseUnits' WHERE define_var='MODULE_ID_UNITS'");
                db_query_safe("UPDATE accueil SET rubrique= ? WHERE define_var='MODULE_ID_UNITS'", array($langCourseUnits), $currentCourseID);
