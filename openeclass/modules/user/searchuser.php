...
if($is_adminOfCourse) {
	...
	$search_nom = htmlspecialchars($search_nom, ENT_QUOTES);
	$search_prenom = htmlspecialchars($search_prenom, ENT_QUOTES);
	$search_uname = htmlspecialchars($search_uname, ENT_QUOTES);
