...
$userphone = htmlspecialchars($userphone, ENT_QUOTES);
$uname = htmlspecialchars($uname, ENT_QUOTES);
$email_form = htmlspecialchars($email_form, ENT_QUOTES);
$usercomment = htmlspecialchars($usercomment, ENT_QUOTES);
...
$registration_errors = array();
    ...
    if (count($registration_errors) == 0) {    // registration is ok
            ...
            /*db_query('INSERT INTO prof_request SET
                     ...
                     $mysqlMainDb);*/
            db_query_safe('INSERT INTO prof_request SET
                     profname = ?,
                     profsurname = ?,
                     profuname = ?,
                     profemail = ?,
                     ...
                     comment = ?,
                     lang = ?',
                    array($prenom_form,$nom_form,$uname,$email_form,$department,$userphone,$usercomment,$proflang),
                    $mysqlMainDb);
