...
// register user
    ...
    $inscr_user=mysql_query("INSERT INTO user
      (user_id, nom, prenom, username, password, email, statut, department, registered_at, expires_at, lang)
      VALUES ('NULL', ?, ?, ?, ?, ?, '5', '$[id]', ?, ?, ?)",
      array($nom_form,$prenom_form,$uname,$password_encrypted,$email_form,$dep,$registered_at,$expires_at,$lang),$mysqlMainDb);
