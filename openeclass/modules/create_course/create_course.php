...
if (isset($_POST['create_course'])) {
        ...
        /*db_query("INSERT INTO cours SET
                        ...
                        faculteid = '$facid',
                        first_create = NOW()");*/
		$result_pdo = db_query_safe("INSERT INTO cours SET
						code = ?,
						languageCourse = ?,
						intitule = ?,
						description = ?,
						...
						faculteid = ?,
						first_create = NOW()",
					array($code,$language,$intitule,$description,$course_addon,$course_keywords,$facname,$formvisible,$titulaires,$code,$type,$facid),
					$mysqlMainDb);
        $new_cours_id =  $result_pdo->lastInsertId(); // mysql_insert_id();
        ...
        /*mysql_query("INSERT INTO cours_user SET
                        ...
                        tutor='1',
                        reg_date = CURDATE()");*/
		db_query_safe("INSERT INTO cours_user SET
						cours_id = ?,
						user_id = ?,
						statut = '1',
						tutor='1',
						reg_date = CURDATE()",
					    array($new_cours_id,$uid),$mysqlMainDb);

        /*mysql_query("INSERT INTO cours_faculte SET
                        faculte = '$faculte',
                        code = '$repertoire',
                      facid = '$facid'");*/
		db_query_safe("INSERT INTO cours_faculte SET
						faculte = ?,
						code = ?,
						facid = ?",
						array($faculte,$repertoire,$facid),$mysqlMainDb);
