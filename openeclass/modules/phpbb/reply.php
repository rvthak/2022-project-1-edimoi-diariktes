...
if (isset($post_id) && $post_id) {
	$post_id = htmlspecialchars($post_id, ENT_QUOTES);
	...
	$result_stm = db_query_safe($sql,array($forum,$topic,$post_id),$currentCourseID,FALSE);
} else {
	...
	$result_stm = db_query_safe($sql,array($forum,$topic),$currentCourseID,FALSE);
}

//$result = db_query($sql, $currentCourseID);
//$myrow = mysql_fetch_array($result);
$myrow = $result_stm->fetch();
...
$topic_title = htmlspecialchars($myrow["topic_title"], ENT_QUOTES);
$forum_id = $forum;
